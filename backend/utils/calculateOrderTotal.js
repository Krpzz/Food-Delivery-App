...
const getEffectivePrice = (item) => (item.discount > 0 ? Math.round(item.price * (1 - item.discount / 100)) : item.price);
...
calculateOrderTotal.getEffectivePrice = getEffectivePrice;
